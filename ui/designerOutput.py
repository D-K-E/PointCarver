...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.thresholdLabel = QtWidgets.QLabel(self.carveGroup)
        self.thresholdLabel.setObjectName("thresholdLabel")
        self.verticalLayout_12.addWidget(self.thresholdLabel)
        self.thresholdSpin = QtWidgets.QSpinBox(self.carveGroup)
        ...
        self.carveDirLabel = QtWidgets.QLabel(self.carveGroup)
